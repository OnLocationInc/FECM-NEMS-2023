...
# re.compile(r'\s*(?P<name>\b[\w+$]+\b)\s*(?P<after>.*)\s*\Z', re.I)
# numpy.f2py.crackfortran.namepattern = re.compile(r'\s*(?P<name>\b[\w+$]+\b)\s*(?P<after>.*)\s*\Z', re.I)
...
#
#
# fileinput.FileInput.readline = readline_new
...
# Compiling .o files
ifort = r'C:/Program Files (x86)/IntelSWTools/Compilers_and_libraries_2018.1.156/windows/bin/intel64/ifort.exe'
...
flags   = r'/free /Qzero /debug:full /assume:nounderscore /IL:/main/jmw/git/NEMS-Albert/includes '
...
sys.argv.extend(['-c',
                 ...
                 '--include-paths', r'../includes',
                 '-m', 'pyfiler',
                 r'-LC:\Progra~2\IntelSWTools\compilers_and_libraries_2018.1.156\windows\compiler\lib\intel64_win',
                 '--fcompiler=intelvem',
                 '--f90flags='+flags])
...
os.environ['PATH'] += r';C:/Progra~2/IntelSWTools/Compilers_and_libraries_2018.1.156/windows/bin/intel64/'
numpy.f2py.main()
# import run_f2py
pass
