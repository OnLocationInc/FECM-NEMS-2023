...
$set PipeOpt 1
$call gams %GAMS_DataPrep_Name% %environ% WorkDir=%RootPath% OptDir=%RootPath% ScrDir=%RootPath% PutDir=%RootPath% ProcDir=%RootPath% --dir=%RootPath% --ForceAllOn=%ForceAll% --InNEMS=%NEMSIntegrated% --UseDAC=%RUNDAC% --HubType=%HUBTYP% --POPT=%PipeOpt%
