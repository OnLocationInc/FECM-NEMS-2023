...
PipeFunds(t) = 0;
TotPipeCapCost(t) = sum((FromNode,ToNode,Diameter), BLDPIPE.l(FromNode,ToNode,Diameter,t) * PipeCapCost(FromNode,ToNode,Diameter,t));
...
loop(t$(t.val ge 2025),
     ...
     PipeCCFund(FromNode,ToNode,Diameter,t)$BLDPIPE.l(FromNode,ToNode,Diameter,t) =
            min(BLDPIPE.l(FromNode,ToNode,Diameter,t) * PipeCapCost(FromNode,ToNode,Diameter,t) / TotPipeCapCost(t) * PipeFundUnused,
                0.5 * BLDPIPE.l(FromNode,ToNode,Diameter,t) * PipeCapCost(FromNode,ToNode,Diameter,t));
     PipeFundUnused = max(0, PipeFundUnused - sum((FromNode,ToNode,Diameter), PipeCCFund(FromNode,ToNode,Diameter,t)));
     );
...
CostWorkTran(FromNode,ToNode,'Fixed')$(sum((Diameter,t), PIPED.l(FromNode,ToNode,Diameter,t)) > 0) =
  sum((Diameter,t), BLDPIPE.l(FromNode,ToNode,Diameter,t) * PipeCapCost(FromNode,ToNode,Diameter,t) - PipeCCFund(FromNode,ToNode,Diameter,t)) /
...
PipeAnn(FromNode,ToNode) =  sum((t,Diameter),(BLDPIPE.l(FromNode,ToNode,Diameter,t) * PipeCapCost(FromNode,ToNode,Diameter,t)
                            - PipeCCFund(FromNode,ToNode,Diameter,t))/CRF("Transport",t)/PV("Transport",t));
