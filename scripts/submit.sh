...
#   outchoice=0
#   while [ $outchoice -lt 1 -o $outchoice -gt 1 -o ]
#   do
#     echo " "
#     echo "     Select an option for your output directory"
#     echo " "
 #    echo "     1)  Shared directory on $suggested   $OUTDIR/$USCEN/$DATE"
 #    echo "     2)  (this option has been removed) " ;# Add path on to current directory : $wpwd/$USCEN/$DATE " 
#     echo "     1)  Specify directory" 
#     echo " "
...
#   if [ $outchoice = "1" ]; then
     echo "     Select an option for your output directory"
     echo -n "  Enter path name where /$USCEN/$DATE/ will reside :";read outdir1
     if [ -n "$outdir1" ] ; then
       OUTDIR=$outdir1
     fi 
#   else
