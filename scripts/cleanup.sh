...
rm -f input/PS*.unf 2>/dev/null
cat bas[1-2][0-9][0-9][0-9].dat > BASEMMO.dat 2>/dev/null;  rm bas[1-2][0-9][0-9][0-9].dat 2>/dev/null
cat efd[1-2][0-9][0-9][0-9].dat > BASEFDO.dat 2>/dev/null;  rm efd[1-2][0-9][0-9][0-9].dat 2>/dev/null
cat cmm[1-2][0-9][0-9][0-9].dat > BASCMMO.dat 2>/dev/null;  rm cmm[1-2][0-9][0-9][0-9].dat 2>/dev/null
cat baspmm*.da > BASPMM1.dat 2>/dev/null 
cat baxpmm*.da > BAXPMM1.dat 2>/dev/null ; rm ba?pmm*.da 2>/dev/null
